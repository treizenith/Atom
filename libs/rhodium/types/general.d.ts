...
import type { Msg, MsgCallback, NatsConnectionOptions, Subscription } from 'ts-nats';
export declare type NatsOption = NatsConnectionOptions;
export interface GemOption {
    natsOption?: NatsOption;
    name?: string;
}
export declare type Handler = (this: Rhodium, head: {
